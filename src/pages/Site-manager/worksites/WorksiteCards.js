            ...
            <button className="flex justify-center items-center border px-3 py-2 rounded-md border-green-500">
              {item.ontime ? (
                ...
                <span className="text-red-500 flex items-center">
                  {" "}
                  <FaCircle className="mr-2" /> Delayed
                </span>
              )}{" "}
          ...
          <div className="text-center mt-4">
            ...
            <table className="mt-5 w-full">
              <tbody>
                ...
                <tr>
                  <td>
                    <p className="">{item.siteManager}</p>
                  </td>
                  {/* <td>
            ...
            <table className="w-full tttable">
              <tbody>
                ...
                <tr>
                  <td>
                    <p className="">{item.restored}</p>
                  </td>
                  <td>
                    <p className="">{item.working}</p>
                  </td>
                  <td>
                    <p className="">{item.finished}</p>
                  </td>
                  <td>
                    <p className="">{item.absent}</p>
                  </td>
                </tr>
              </tbody>
            </table>
            ...
            <p className="bg-[#D5E9FE] p-2 mt-4">
              Estimated End Date: 08 Jan 2023
            </p>
          </div>
        </div>
      ))}
